...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='deit_base_patch16_384', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='Vim/data_set/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='CIFAR', choices=['CIFAR', 'MNIST', 'IMNET', 'INAT', 'INAT19'],
